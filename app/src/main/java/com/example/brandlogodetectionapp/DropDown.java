    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(v -> {
            if (selectedState.equals("Select Your State")) {
                Toast.makeText(DropDown.this, "Please select your state from the list", Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(DropDown.this, "Please select your district from the list", Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(DropDown.this, "Selected State: "+selectedState+"\nSelected District: "+selectedDistrict, Toast.LENGTH_LONG).show();
            }
        });
    }
